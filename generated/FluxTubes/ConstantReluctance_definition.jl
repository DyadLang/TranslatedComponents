...
@component function ConstantReluctance(; name, R_m=1)
  ...
  ### Symbolic Parameters
  __params = Any[]
  append!(__params, @parameters (R_m::Real = R_m), [description = "Magnetic reluctance"])
...
export ConstantReluctance

Base.show(io::IO, a::MIME"image/svg+xml", t::typeof(ConstantReluctance)) = print(io,
