...
@doc Markdown.doc"""
   QuarterSphere(; name, r)

## Parameters: 

| Name         | Description                         | Units  |   Default value |
| ------------ | ----------------------------------- | ------ | --------------- |
| `r`         | Radius of quarter sphere                         | m  |   0.005 |
...
"""
@component function QuarterSphere(; name, r=0.005)

  ### Symbolic Parameters
  __params = Any[]
  append!(__params, @parameters (r::Real = r), [description = "Radius of quarter sphere"])
  ...
  push!(__eqs, G_m ~ 0.00000125663706212 * 0.077 * 2 * r)
...
export QuarterSphere

Base.show(io::IO, a::MIME"image/svg+xml", t::typeof(QuarterSphere)) = print(io,
