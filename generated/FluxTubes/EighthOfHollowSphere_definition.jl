...
"""
@component function EighthOfHollowSphere(; name, t=0.01)

  ### Symbolic Parameters
  __params = Any[]
  append!(__params, @parameters (t::Real = t), [description = "Thickness of spherical shell"])
  ...
  push!(__eqs, G_m ~ 0.00000125663706212 * 0.5 * t)
...
export EighthOfHollowSphere

Base.show(io::IO, a::MIME"image/svg+xml", t::typeof(EighthOfHollowSphere)) = print(io,
