...
@component function Crossing(; name)
  ...
  ### Components
  __systems = ODESystem[]
  push!(__systems, @named port_p1 = FluxTubes.MagneticPort())
  push!(__systems, @named port_p2 = FluxTubes.MagneticPort())
  push!(__systems, @named port_n1 = FluxTubes.MagneticPort())
  push!(__systems, @named port_n2 = FluxTubes.MagneticPort())
