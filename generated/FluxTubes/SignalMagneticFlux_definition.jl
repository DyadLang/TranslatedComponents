...
"""
@component function SignalMagneticFlux(; name)
  ...
  append!(__vars, @variables (V_m(t)::Real), [description = "Magnetic potential difference between both ports"])
...
export SignalMagneticFlux

Base.show(io::IO, a::MIME"image/svg+xml", t::typeof(SignalMagneticFlux)) = print(io,
