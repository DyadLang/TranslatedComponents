...
"""
@component function ConstantPermeance(; name, G_m=1)

  ### Symbolic Parameters
  __params = Any[]
  append!(__params, @parameters (G_m::Real = G_m), [description = "Magnetic permeance"])
...
export ConstantPermeance

Base.show(io::IO, a::MIME"image/svg+xml", t::typeof(ConstantPermeance)) = print(io,
