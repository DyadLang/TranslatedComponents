 ...
 * `R_m` - This connector represents a real signal as an input to a component ([`RealInput`](@ref))
...
"""
@component function VariableReluctance(; name)
  ...
  ### Variables
  __vars = Any[]
  append!(__vars, @variables (R_m(t)::Real), [input = true])
...
export VariableReluctance

Base.show(io::IO, a::MIME"image/svg+xml", t::typeof(VariableReluctance)) = print(io,
