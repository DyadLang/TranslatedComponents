 ...
 * `G_m` - This connector represents a real signal as an input to a component ([`RealInput`](@ref))
...
"""
@component function VariablePermeance(; name)
  ...
  ### Variables
  __vars = Any[]
  append!(__vars, @variables (G_m(t)::Real), [input = true])
...
export VariablePermeance

Base.show(io::IO, a::MIME"image/svg+xml", t::typeof(VariablePermeance)) = print(io,
