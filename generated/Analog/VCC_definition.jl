...
@doc Markdown.doc"""
   VCC(; name, transConductance)

## Parameters: 

| Name         | Description                         | Units  |   Default value |
| ------------ | ----------------------------------- | ------ | --------------- |
| `transConductance`         | Transconductance                         | S  |   1 |
...
"""
@component function VCC(; name, transConductance=1)

  ### Symbolic Parameters
  __params = Any[]
  append!(__params, @parameters (transConductance::Real = transConductance), [description = "Transconductance"])
  ...
  push!(__eqs, i2 ~ v1 * transConductance)
  push!(__eqs, i1 ~ 0)
...
Base.show(io::IO, a::MIME"image/svg+xml", t::typeof(VCC)) = print(io,
