...
@doc Markdown.doc"""
   CCV(; name, transResistance)

## Parameters: 

| Name         | Description                         | Units  |   Default value |
| ------------ | ----------------------------------- | ------ | --------------- |
| `transResistance`         | Transresistance                         | Ω  |   1 |
...
"""
@component function CCV(; name, transResistance=1)

  ### Symbolic Parameters
  __params = Any[]
  append!(__params, @parameters (transResistance::Real = transResistance), [description = "Transresistance"])
  ...
  push!(__eqs, v2 ~ i1 * transResistance)
  push!(__eqs, v1 ~ 0)
...
Base.show(io::IO, a::MIME"image/svg+xml", t::typeof(CCV)) = print(io,
