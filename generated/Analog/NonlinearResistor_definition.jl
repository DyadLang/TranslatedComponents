...
@component function NonlinearResistor(; name, Ga=nothing, Gb=nothing, Ve=nothing)
  ...
  ### Symbolic Parameters
  __params = Any[]
  append!(__params, @parameters (Ga::Real = Ga), [description = "Conductance in inner voltage range"])
  append!(__params, @parameters (Gb::Real = Gb), [description = "Conductance in outer voltage range"])
  append!(__params, @parameters (Ve::Real = Ve), [description = "Inner voltage range limit"])
