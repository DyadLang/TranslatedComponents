...
@doc Markdown.doc"""
   ControlledOpenerWithArc(; name, useHeatPort, T, Ron, Goff, V0, dVdt, Vmax, level)
...
"""
@component function ControlledOpenerWithArc(; name, useHeatPort=false, T=293.15, Ron=0.00001, Goff=0.00001, V0=30, dVdt=10000, Vmax=60, level=0.5)
...
export ControlledOpenerWithArc

Base.show(io::IO, a::MIME"image/svg+xml", t::typeof(ControlledOpenerWithArc)) = print(io,
