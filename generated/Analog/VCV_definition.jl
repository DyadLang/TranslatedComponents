...
"""
@component function VCV(; name, gain=1)

  ### Symbolic Parameters
  __params = Any[]
  append!(__params, @parameters (gain::Real = gain), [description = "Voltage gain"])
...
Base.show(io::IO, a::MIME"image/svg+xml", t::typeof(VCV)) = print(io,
