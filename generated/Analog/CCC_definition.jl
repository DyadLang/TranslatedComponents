...
"""
@component function CCC(; name, gain=1)

  ### Symbolic Parameters
  __params = Any[]
  append!(__params, @parameters (gain::Real = gain), [description = "Current gain"])
...
Base.show(io::IO, a::MIME"image/svg+xml", t::typeof(CCC)) = print(io,
