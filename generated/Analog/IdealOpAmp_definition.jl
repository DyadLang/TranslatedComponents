...
@component function IdealOpAmp(; name)
  ...
  ### Variables
  __vars = Any[]
  append!(__vars, @variables (v1(t)::Real), [description = "Voltage drop over the left port"])
  append!(__vars, @variables (v2(t)::Real), [description = "Voltage drop over the right port"])
  append!(__vars, @variables (i1(t)::Real), [description = "Current flowing from pos. to neg. pin of the left port"])
  append!(__vars, @variables (i2(t)::Real), [description = "Current flowing from pos. to neg. pin of the right port"])
...
Base.show(io::IO, a::MIME"image/svg+xml", t::typeof(IdealOpAmp)) = print(io,
