 ...
 * `Q_flow` - This connector represents a real signal as an output from a component ([`RealOutput`](@ref))
...
@component function HeatFlowSensor(; name)
  ...
  ### Variables
  __vars = Any[]
  append!(__vars, @variables (Q_flow(t)::Real), [output = true])
  ...
  ### Equations
  __eqs = Equation[]
  push!(__eqs, port_a.T ~ port_b.T)
  push!(__eqs, port_a.Q_flow + port_b.Q_flow ~ 0)
  push!(__eqs, Q_flow ~ port_a.Q_flow)
...
export HeatFlowSensor

Base.show(io::IO, a::MIME"image/svg+xml", t::typeof(HeatFlowSensor)) = print(io,
