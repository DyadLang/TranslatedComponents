...
| ------------ | ----------------------------------- | ------ | --------------- |
| `Gr`         | Net radiation conductance between two surfaces (see docu)                         | --  |    |
...
"""
@component function BodyRadiation(; name, Gr=nothing)

  ### Symbolic Parameters
  __params = Any[]
  append!(__params, @parameters (Gr::Float64 = Gr), [description = "Net radiation conductance between two surfaces (see docu)"])
  ...
  push!(__eqs, Q_flow ~ Gr * 5.670374419e-8 * (port_a.T^4 - port_b.T^4))

  # Return completely constructed ODESystem
  return ODESystem(__eqs, t, __vars, __params; systems=__systems, defaults=__defaults, name, initialization_eqs=__initialization_eqs)
end
export BodyRadiation

Base.show(io::IO, a::MIME"image/svg+xml", t::typeof(BodyRadiation)) = print(io,
