 ...
 * `phi_start` - This connector represents a real signal as an input to a component ([`RealInput`](@ref))
...
"""
@component function Set_phi_start(; name)
  ...
  ### Variables
  __vars = Any[]
  append!(__vars, @variables (phi_start(t)::Real), [input = true])
  ...
  ### Defaults
  __defaults = Dict()
  __defaults[flange.phi] = (phi_start)
...
export Set_phi_start

Base.show(io::IO, a::MIME"image/svg+xml", t::typeof(Set_phi_start)) = print(io,
