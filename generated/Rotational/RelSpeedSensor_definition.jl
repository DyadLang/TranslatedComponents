 ...
 * `w_rel` - This connector represents a real signal as an output from a component ([`RealOutput`](@ref))
...
@component function RelSpeedSensor(; name)
  ...
  ### Variables
  __vars = Any[]
  append!(__vars, @variables (w_rel(t)::Real), [output = true])
...
Base.show(io::IO, a::MIME"image/svg+xml", t::typeof(RelSpeedSensor)) = print(io,
