...
@doc Markdown.doc"""
   ConstantSpeed(; name, useSupport, w_fixed)
...
"""
@component function ConstantSpeed(; name, useSupport=false, w_fixed=nothing)

  ### Symbolic Parameters
  __params = Any[]
  append!(__params, @parameters (w_fixed::Real = w_fixed), [description = "Fixed speed"])
...
export ConstantSpeed

Base.show(io::IO, a::MIME"image/svg+xml", t::typeof(ConstantSpeed)) = print(io,
