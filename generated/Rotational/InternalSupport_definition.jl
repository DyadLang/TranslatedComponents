...
| ------------ | ----------------------------------- | ------ | 
| `phi`         | External support angle (= flange.phi)                         | rad  | 
"""
@component function InternalSupport(; name)
  ...
  append!(__vars, @variables (phi(t)::Real), [description = "External support angle (= flange.phi)"])
...
Base.show(io::IO, a::MIME"image/svg+xml", t::typeof(InternalSupport)) = print(io,
