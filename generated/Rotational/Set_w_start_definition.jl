 ...
 * `w_start` - This connector represents a real signal as an input to a component ([`RealInput`](@ref))
...
"""
@component function Set_w_start(; name)
  ...
  ### Variables
  __vars = Any[]
  append!(__vars, @variables (w_start(t)::Real), [input = true])
  ...
  push!(__initialization_eqs, D(flange.phi) ~ w_start)
...
Base.show(io::IO, a::MIME"image/svg+xml", t::typeof(Set_w_start)) = print(io,
