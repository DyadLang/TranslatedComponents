...
| `w_rel`         | Relative angular velocity between two flanges                         | rad/s  | 
"""
@component function RelAccSensor(; name)
  ...
  append!(__vars, @variables (phi_rel(t)::Real), [description = "Relative angle between two flanges (flange_b.phi - flange_a.phi)"])
  append!(__vars, @variables (w_rel(t)::Real), [description = "Relative angular velocity between two flanges"])
  ...
  push!(__eqs, w_rel ~ D(phi_rel))
  push!(__eqs, a_rel ~ D(w_rel))
