...
@doc Markdown.doc"""
   Sign(; name, generateEvent)

## Parameters: 

| Name         | Description                         | Units  |   Default value |
| ------------ | ----------------------------------- | ------ | --------------- |
| `generateEvent`         | Choose whether events shall be generated                         | --  |   false |
...
"""
@component function Sign(; name, generateEvent=false)
  ...
  ### Equations
  __eqs = Equation[]
  push!(__eqs, y ~ ifelse(generateEvent, (ifelse(u > 0, 1, (ifelse(u < 0, -1, 0)))), (ifelse(ModelingToolkit.no_if_lifting(u > 0), 1, (ifelse(ModelingToolkit.no_if_lifting(u < 0), -1, 0))))))
...
Base.show(io::IO, a::MIME"image/svg+xml", t::typeof(Sign)) = print(io,
