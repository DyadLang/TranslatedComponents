...
@component function Abs(; name, generateEvent=false)
  ...
  ### Equations
  __eqs = Equation[]
  push!(__eqs, y ~ ifelse(generateEvent, (ifelse(u >= 0, u, -u)), (ifelse(ModelingToolkit.no_if_lifting(u >= 0), u, -u))))
...
Base.show(io::IO, a::MIME"image/svg+xml", t::typeof(Abs)) = print(io,
