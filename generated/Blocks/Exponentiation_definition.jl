...
"""
@component function Exponentiation(; name, exponent=2)

  ### Symbolic Parameters
  __params = Any[]
  append!(__params, @parameters (exponent::Real = exponent), [description = "Exponent of power"])
...
Base.show(io::IO, a::MIME"image/svg+xml", t::typeof(Exponentiation)) = print(io,
