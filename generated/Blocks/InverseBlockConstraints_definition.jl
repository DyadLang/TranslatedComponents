...
"""
@component function InverseBlockConstraints(; name)
...
export InverseBlockConstraints

Base.show(io::IO, a::MIME"image/svg+xml", t::typeof(InverseBlockConstraints)) = print(io,
