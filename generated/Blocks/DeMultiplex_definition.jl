...
| ------------ | ----------------------------------- | ------ | --------------- |
| `n`         | Dimension of output signal connector                         | --  |   0 |

## Connectors

 * `u` - This connector represents a real signal as an input to a component ([`RealInput`](@ref))
 * `y` - ([`RealVectorOutput`](@ref))
"""
@component function DeMultiplex(; name, n=0)

  ### Symbolic Parameters
  __params = Any[]
  append!(__params, @parameters (n::Int64 = n), [description = "Dimension of output signal connector"])
...
Base.show(io::IO, a::MIME"image/svg+xml", t::typeof(DeMultiplex)) = print(io,
