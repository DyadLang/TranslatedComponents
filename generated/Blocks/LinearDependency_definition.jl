...
@doc Markdown.doc"""
   LinearDependency(; name, y0, k1, k2)
...
"""
@component function LinearDependency(; name, y0=0, k1=0, k2=0)

  ### Symbolic Parameters
  __params = Any[]
  append!(__params, @parameters (y0::Real = y0), [description = "Initial value"])
  append!(__params, @parameters (k1::Real = k1), [description = "Gain of u1"])
  append!(__params, @parameters (k2::Real = k2), [description = "Gain of u2"])
...
Base.show(io::IO, a::MIME"image/svg+xml", t::typeof(LinearDependency)) = print(io,
