...
| ------------ | ----------------------------------- | ------ | --------------- |
| `n`         | Dimension of input signal connector                         | --  |   0 |
...
"""
@component function Multiplex(; name, n=0)

  ### Symbolic Parameters
  __params = Any[]
  append!(__params, @parameters (n::Int64 = n), [description = "Dimension of input signal connector"])
...
Base.show(io::IO, a::MIME"image/svg+xml", t::typeof(Multiplex)) = print(io,
