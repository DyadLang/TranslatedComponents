...
@doc Markdown.doc"""
   DeMultiplex6(; name, n1, n2, n3, n4, n5, n6)
...
| `n6`         | Dimension of output signal connector 6                         | --  |   1 |
...
"""
@component function DeMultiplex6(; name, n1=1, n2=1, n3=1, n4=1, n5=1, n6=1)
  ...
  append!(__params, @parameters (n3::Int64 = n3), [description = "Dimension of output signal connector 3"])
  append!(__params, @parameters (n4::Int64 = n4), [description = "Dimension of output signal connector 4"])
  append!(__params, @parameters (n5::Int64 = n5), [description = "Dimension of output signal connector 5"])
  append!(__params, @parameters (n6::Int64 = n6), [description = "Dimension of output signal connector 6"])
  ...
  ### Equations
  __eqs = Equation[]
  push!(__eqs, [u] ~ [y1, y2, y3, y4, y5, y6])
...
Base.show(io::IO, a::MIME"image/svg+xml", t::typeof(DeMultiplex6)) = print(io,
