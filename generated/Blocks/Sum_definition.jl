...
| `k`         | Optional: sum coefficients                         | --  |   ones(nin) |
...
"""
@component function Sum(; name, nin=1, k=ones(nin))

  ### Symbolic Parameters
  __params = Any[]
  append!(__params, @parameters (nin::Int64 = nin), [description = "Number of inputs"])
  append!(__params, @parameters (k::Real = k), [description = "Optional: sum coefficients"])
...
Base.show(io::IO, a::MIME"image/svg+xml", t::typeof(Sum)) = print(io,
