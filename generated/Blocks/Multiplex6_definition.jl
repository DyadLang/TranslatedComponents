...
@doc Markdown.doc"""
   Multiplex6(; name, n1, n2, n3, n4, n5, n6)
...
"""
@component function Multiplex6(; name, n1=1, n2=1, n3=1, n4=1, n5=1, n6=1)
  ...
  append!(__params, @parameters (n4::Int64 = n4), [description = "Dimension of input signal connector 4"])
  append!(__params, @parameters (n5::Int64 = n5), [description = "Dimension of input signal connector 5"])
  append!(__params, @parameters (n6::Int64 = n6), [description = "Dimension of input signal connector 6"])
...
Base.show(io::IO, a::MIME"image/svg+xml", t::typeof(Multiplex6)) = print(io,
