...
@component function RealToBoolean(; name, threshold=0.5)
  ...
  ### Symbolic Parameters
  __params = Any[]
  append!(__params, @parameters (threshold::Real = threshold), [description = "Output signal y is true, if input u >= threshold"])
...
export RealToBoolean

Base.show(io::IO, a::MIME"image/svg+xml", t::typeof(RealToBoolean)) = print(io,
