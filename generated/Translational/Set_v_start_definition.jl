 ...
 * `v_start` - This connector represents a real signal as an input to a component ([`RealInput`](@ref))
...
"""
@component function Set_v_start(; name)
  ...
  ### Variables
  __vars = Any[]
  append!(__vars, @variables (v_start(t)::Real), [input = true])
  ...
  push!(__initialization_eqs, D(flange.s) ~ v_start)
...
Base.show(io::IO, a::MIME"image/svg+xml", t::typeof(Set_v_start)) = print(io,
