 ...
 * `s_rel` - This connector represents a real signal as an output from a component ([`RealOutput`](@ref))
"""
@component function RelPositionSensor(; name)
  ...
  ### Variables
  __vars = Any[]
  append!(__vars, @variables (s_rel(t)::Real), [output = true])
...
export RelPositionSensor

Base.show(io::IO, a::MIME"image/svg+xml", t::typeof(RelPositionSensor)) = print(io,
