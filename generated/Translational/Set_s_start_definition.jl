 ...
 * `s_start` - This connector represents a real signal as an input to a component ([`RealInput`](@ref))
...
"""
@component function Set_s_start(; name)
...
Base.show(io::IO, a::MIME"image/svg+xml", t::typeof(Set_s_start)) = print(io,
